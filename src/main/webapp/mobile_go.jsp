...
<body>
	<ul class="show-box">
		<li>
			<button type="button" id="block1" class="block1">教育（一）</button>
		</li>
		<li>
			<button type="button" id="block2" class="block2">教育（二）</button>
		</li>
		<li>
			<button type="button" id="block3" class="block3" disabled="disabled">教育（三）</button>
		</li>
	</ul>
