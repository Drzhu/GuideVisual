...
<link rel="stylesheet" type="text/css" href="<%=base %>/css/manage_css/css.css" />
<link rel="stylesheet" type="text/css" href="<%=base %>/css/manage_css/supersized.css" />
<link rel="stylesheet" type="text/css" href="<%=base %>/css/animate.min.css" />
<link rel="shortcut icon" href="<%=base %>/img/guide.ico" />
<title>用户登录</title>
</head>
<body class="enter-body">
	...
	<script src="<%=base %>/js/loginbg/jquery-2.2.4.min.js"></script>
			...
			$("#block1").on("click",function(){
				$.ajax({
					...
					success : function(res) {
						console.log(res);
						if(res == "success"){
							window.location.href = "ascvd/hospital";	
						}else{
							return false;
						}
