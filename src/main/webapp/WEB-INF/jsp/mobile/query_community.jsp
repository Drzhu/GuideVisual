...
<body style="background: #fff;">
	<nav class="navbar navbar-inverse custom-navbar"
		...
		<div class="container">
			<div class="navbar-header">
				<a href="" class="navbar-brand"> 基层慢病管理信息查询 </a>
			</div>
		</div>
	</nav>
	...
	$(function(){
		...
		$("#doc_info_filter input[type=search]").addClass("form-control").attr("placeholder","按城市、医院、姓名、科室搜索").css("padding-left","30px");
	});	
	</script>
</body>
</html>
