...
<body class="enter-body">
	<ul class="show-box animated ">
		<li>
			<button type="button" id="block1" class="block1">立普妥</button>
		</li>
		<li>
			<button type="button" id="block2" class="block2">社区医生</button>
		</li>
		<li>
			<button type="button" id="block3" class="block3" disabled="disabled">百万血管</button>
		</li>
	</ul>
	
	<div id="login1" class="login-box animated ">
		<div class="login-logo">立普妥</div>
